...
class Boid1 {
  ...
  float attentionRange;
    ...
    Boid1(float x, float y, PVector circleClr, PVector flockCenter, int imageSize) {
    ...
    float variance = 5.0;
    position = new PVector((randomGaussian() * variance) + flockCenter.x, (randomGaussian() * variance) + flockCenter.y);
    r = 2.0;
